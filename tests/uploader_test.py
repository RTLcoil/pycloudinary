...
class UploaderTest(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        if cls.resources_to_delete:
            for t in RESOURCE_UPLOAD_TYPES:
                if cls.resources_to_delete.get(t):
                    cloudinary.api.delete_resources(cls.resources_to_delete.get(t), type=t)
    ...
    @classmethod
    def get_unique_public_id(cls, res_upload_type='upload'):
        ...
        public_id = generate_public_id(res_upload_type, suffix = suffix)
