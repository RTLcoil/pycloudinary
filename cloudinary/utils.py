...
def is_remote_url(file):
    """Basic URL scheme check to define if it's remote URL. Regexp copied from uploader.call_api()"""
    return True if isinstance(file, string_types) and re.match(REMOTE_URL_RE, file) else False