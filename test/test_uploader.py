...
import cloudinary
from cloudinary import api, uploader, utils, errors
...
""",
    ...
    def test_rename(self):
        ...
        self.assertRaises(errors.Error, uploader.rename,
    ...
    def test_allowed_formats_with_illegal_format(self):
        ...
        self.assertRaises(errors.Error, uploader.upload, TEST_IMAGE, allowed_formats=['jpg'])
    ...
    def test_raw_conversion(self):
        ...
        with six.assertRaisesRegex(self, errors.Error, 'Raw convert is invalid'):
    ...
    def test_categorization(self):
        ...
        with six.assertRaisesRegex(self, errors.Error, 'is not valid'):
            uploader.upload(TEST_IMAGE, categorization="illegal", tags=[UNIQUE_TAG])

    @unittest.skipUnless(cloudinary.config().api_secret, "requires api_key/api_secret")
    def test_detection(self):
        """ should support requesting detection """
        with six.assertRaisesRegex(self, errors.Error, 'Detection is invalid'):
    ...
    def test_background_removal(self):
        ...
        with six.assertRaisesRegex(self, errors.Error, 'is invalid'):
            uploader.upload(TEST_IMAGE, background_removal="illegal", tags=[UNIQUE_TAG])

    @unittest.skipUnless(cloudinary.config().api_secret, "requires api_key/api_secret")
    def test_upload_timeout(self):
        with six.assertRaisesRegex(self, cloudinary.errors.Error, 'timed out'):
